...
public class UserActionServiceImpl implements UserActionService {
  ...
  public void sendEmailConfirmationMail(User user) {
    ...
    String subject = localizeErrorMessage("user.mail.email.confirm.subject",
        new Object[] { user.getFirstname() + " " + user.getLastname() });
    String sialToken = signAction(DomainConstants.CONFIRM_EMAIL, user.getId());
    String url = RESTConstants.SLASH + user.getId() + RESTConstants.SLASH + DomainConstants.CONFIRM_EMAIL
        + RESTConstants.SLASH + sialToken;
    String body = localizeErrorMessage("user.mail.email.confirm.body",
        new Object[] { user.getFirstname() + " " + user.getLastname() }) + " <a href='" + url + "'>"
        + localizeErrorMessage("user.mail.email.confirm.link", null) + "</a>"
  ...
  private void sendHtmlMail(final String to, final String from, final String subject, final String body,
      final boolean isHtml, final List<String> filenames) {
