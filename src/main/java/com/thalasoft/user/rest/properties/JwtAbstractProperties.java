...
public abstract class JwtAbstractProperties implements JwtProperties {
  ...
  private String sslPublicKeyFilename;
  ...
  public String getSslPublicKeyFilename() {
    return this.sslPublicKeyFilename;
  }

  public void setSslPublicKeyFilename(String sslPublicKeyFilename) {
    this.sslPublicKeyFilename = sslPublicKeyFilename;
  }
