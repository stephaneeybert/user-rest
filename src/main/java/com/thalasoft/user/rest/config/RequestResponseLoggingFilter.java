...
public class RequestResponseLoggingFilter extends OncePerRequestFilter {
  ...
  private static void logRequestHeader(ContentCachingRequestWrapper request, String prefix) {
    Optional<String> optQueryString = Optional.ofNullable(request.getQueryString());
    optQueryString.ifPresentOrElse(
        queryString -> log.info("{} {} {}?{}", prefix, request.getMethod(), request.getRequestURI(), queryString),
